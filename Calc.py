...
# Add the path of the Moon-icon, Sun-icon, History-icon by removing the fake path and adding your paths of those files (You can download them via a zip file in this repo)
